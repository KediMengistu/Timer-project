        ...
        >
          <div className="relative grid h-full w-full grid-rows-[auto_1fr]">
            ...
            <div
              ...
              className="scrollbar-thin relative flex h-full w-full snap-x snap-mandatory scroll-p-1! items-center overflow-x-auto border-t-2 border-black pt-1! pr-1! pb-2! pl-1! whitespace-nowrap dark:border-gray-700 dark:bg-gray-800"
            >
